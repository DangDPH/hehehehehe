...
public abstract interface ImdbApiService {
    ...
    @retrofit2.http.GET(value = "movies/top-rated")
    ...
    @retrofit2.http.GET(value = "movies/get-now-playing")
    @org.jetbrains.annotations.NotNull()
    ...
    @retrofit2.http.GET(value = "movies/coming-soon")
    @org.jetbrains.annotations.NotNull()
    ...
    @retrofit2.http.GET(value = "tv/top-rated")
    @org.jetbrains.annotations.NotNull()
